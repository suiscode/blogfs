...
const PostCard = () => {
  return (
    <div className='flex flex-col gap-5 mb-5'>
      ...
      <div className=''>
        <h1 className='w-[90%] text-2xl mb-5 font-semibold'>Title</h1>
        <p className='w-[90%] font-light text-gray-400 mb-5'>Description</p>
        <Link href={`/blog/1`} className="underline">READ MORE</Link>
      </div>
    </div>
  )
}
